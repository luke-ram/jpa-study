...
public class OrderQueryRepository {
    ...
    private List<OrderQueryDto> findOrders() {
        return em.createQuery(
                "select new sooram.study.jpa.repository.order.query.OrderQueryDto(o.id, o.member.name, o.orderDate,o.status, o.delivery.address) " +
                        " from Order o" +
                        " join o.member m" +
    ...
    private List<OrderItemQueryDto> findOrderItems(Long orderId) {
        return em.createQuery(
                "select new sooram.study.jpa.repository.order.query.OrderItemQueryDto(oi.order.id, i.name, oi.orderPrice, oi.count)" +
                        " from OrderItem oi" +
                        " join oi.item i" +
    ...
    public List<OrderFlatDto> findAllByDto_flat() {
        return em.createQuery(
                "select new sooram.study.jpa.repository.order.query.OrderFlatDto(o.id, m.name, o.orderDate, o.status, d.address, i.name, oi.orderPrice, oi.count) from Order o" +
                        " join o.member m" +
                        " join o.delivery d" +
